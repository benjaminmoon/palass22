...
```{r load_data}
data <-
  read_tsv("../occurrence_data/my_ichthyosaur_occurrences.tsv") |>
  filter(
    accepted_rank == "species",
  ) |>
  mutate(accepted_name = str_remove(accepted_name, "cf. |\\?")) |>
