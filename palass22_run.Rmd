...
```{r species_plots}
list.age <- list.files("./pyrate_mcmc_logs", pattern = "TPP-ages_Grj_mcmc")
...
output_revbayes_skyline_runfiles(occurrences = data, bins = stages,
  output_prefix = paste0(dirs$revbayes, "stages"))
output_revbayes_skyline_runfiles(occurrences = data, bins = substages,
  output_prefix = paste0(dirs$revbayes, "substages"))

old_par <- par()

stage_rate <- compute_revbayes_rates(paste0(dirs$revbayes, "output/"),
  match = "stage")
...
substage_rate <- compute_revbayes_rates(paste0(dirs$revbayes, "output/"),
  match = "substage")
