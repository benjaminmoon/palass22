...
python3 /user/home/glbcm/PyRate/PyRate.py -n 100000000 -s 1000 -j $SLURM_ARRAY_TASK_ID -out ichthyosaurs_occurrences-TPP-ages /user/home/glbcm/ichthy_pyrate/ichthyosaur_species_occurrences_PyRate.py -mG -A 4 -fixShift stages
