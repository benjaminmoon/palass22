#!/bin/bash
### combine TPP ages logs
#SBATCH --job-name=combine-TPP-ages
#SBATCH --output=combine-TPP-ages-out
...
# combine PyRate logs
# python3 $PYRATESCRIPT -combLogRJ ./pyrate_mcmc_logs/ -b 100 -tag TPP-ages

# create plot
python3 $PYRATESCRIPT -plotRJ ./pyrate_mcmc_logs/ -grid_plot 0.1 -tag combined_10TPP-ages
